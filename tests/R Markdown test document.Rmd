...
- Pearson’s product-moment correlation: `r report(results, "M2_1")`
- Kendall’s rank correlation tau: `r report(results, "M2_2")`
- Spearman’s rank correlation rho: `r report(results, "M2_3")`
