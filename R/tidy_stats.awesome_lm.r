#' Create a tidy stats data frame from an awesome_lm object
#'
#' \code{tidy_stats.lm} takes an awesome_lm object and converts the object to a tidy stats data frame.
#'
#' @param model An awsome_lm object
#'
#' @examples
